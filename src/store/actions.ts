import type { AppState, ViewMode, Theme, HoldAction, TrashAutoPurge, SnipSort, ToolbarPosition, Folder, Snip, Section, Tag } from '../types'
...
export type Action =
  ...
  | { type: 'IMPORT_DATA'; payload: { folders: Folder[]; snips: Snip[]; sections: Section[]; tags: Tag[] } }
