...
export function TipsFooter({ visible }: TipsFooterProps) {
  ...
  return (
    ...
    >
      <div className="border-t border-border px-4 py-2 flex items-center justify-center gap-2.5">
        <svg
        ...
        <p className={`text-[11px] text-muted transition-opacity duration-500 ${tipVisible ? 'opacity-100' : 'opacity-0'}`}>
          {TIPS[tipIndex]}
        </p>
      </div>
    </div>
